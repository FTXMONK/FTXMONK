        ...
        <div className="flex items-center gap-4">
          {user ? (
            ...
            <button 
              ...
              className="flex items-center gap-2 px-4 py-2 bg-white/5 hover:bg-white/10 border border-white/10 rounded-sm transition-all group"
            >
              ...
              <span className="text-[10px] font-orbitron font-bold tracking-widest text-white uppercase">Sign in with Google</span>
            </button>
          )}
          ...
          >
            <div className="flex justify-between items-end mb-12">
              ...
              {user ? (
                ...
                <button 
                  onClick={signInWithGoogle}
                  className="px-6 py-3 bg-white/5 hover:bg-white/10 border border-white/10 rounded-sm flex items-center gap-3 transition-all group"
                >
                  ...
                  <span className="text-xs font-orbitron font-bold tracking-widest text-white uppercase">Sign in to Review</span>
                </button>
              )}
            </div>
